...
<div class="topbar">
    <div class="screen-selector-container">
        ...
        <select id="screen-selector" on:change={onScreenChange} bind:value={selectedScreen}>
    ...
    {#if activeWallpaper}
        <p class="current-status">
            Currently using: <strong>{activeWallpaper.projectData?.title || activeWallpaper.folderName}</strong> on {selectedScreen}
        </p>
    {/if}
